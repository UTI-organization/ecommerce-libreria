<?php
/**
 * Libreria_Customize_Base_Option class for adding customizer options.
 *
 * Class Libreria_Customize_Base_Option
 *
 * @package    ThemeGrill
 * @subpackage Libreria
...
class Libreria_Customize_Base_Option {
	...
	/**
	 * Registers the customize panels, sections and controls.
	 */
	public function __construct() {

		// Register the customize panels, sections and controls.
		add_filter( 'libreria_customizer_options', array( $this, 'register_options' ), 10, 2 );
	...
	public function get_section_description( $args ) {
		...
		// Description.
		$content  = '<div class="libreria-section-description">';
...
return new Libreria_Customize_Base_Option();
