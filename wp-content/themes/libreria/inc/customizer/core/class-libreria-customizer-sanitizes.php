<?php
/**
 * Libreria customizer class for theme options sanitization.
 *
 * Class Libreria_Customizer_Sanitizes
 *
 * @package    ThemeGrill
 * @subpackage Libreria
...
class Libreria_Customizer_Sanitizes {
	 ...
	 *
	 * @param string $color   Input from the customize controls.
	 * @param string $setting Setting object of the customize controls.
	 *
	 * @return string
	 */
	...
	public static function sanitize_typography( $typography_args, $setting ) {
		...
		if ( isset( $typography_args['subsets'] ) ) {
			...
			$subsets        = Libreria_Fonts::get_google_font_subsets();
