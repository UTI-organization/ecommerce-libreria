		...
		wp.customize.bind(
			...
			function () {
				...
				wp.customize.section.each(
					function ( section ) {
						if (
							'libreria_section' !== section.params.type ||
				...
				wp.customize.panel.each(
					function ( panel ) {
						if (
							'libreria_panel' !== panel.params.type ||
		...
		wp.customize.Panel = wp.customize.Panel.extend(
			{
				attachEvents         : function () {
					...
					if (
						'libreria_panel' !== this.params.type ||
				...
				isContextuallyActive : function () {
					...
					if ( 'libreria_panel' !== this.params.type ) {
		...
		wp.customize.Section = wp.customize.Section.extend(
			{
				attachEvents         : function () {
					...
					if (
						'libreria_section' !== this.params.type ||
				...
				isContextuallyActive : function () {
					...
					if ( 'libreria_section' !== this.params.type ) {
				...
				wp.customize.control.each(
					function ( ctrl, i ) {
						...
						if ( description.length ) {
							...
							li_wrapper.append( '<i class="libreria-control-tooltip dashicons dashicons-editor-help" title="' + tooltip + '"></i>' );
						}
					}
				);
			}
 ...
 *
 * Currently used for the Libreria Upseel section only.
 */
(
	function ( $, api ) {
		api.sectionConstructor[ 'libreria-upsell-section' ] = api.Section.extend(
			{
