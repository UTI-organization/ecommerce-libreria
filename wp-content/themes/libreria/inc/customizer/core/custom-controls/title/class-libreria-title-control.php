 ...
 * Class Libreria_Title_Control
 */
class Libreria_Title_Control extends Libreria_Customize_Base_Additional_Control {
	 ...
	 * @var string
	 */
	public $type = 'libreria-title';

	/**
	 * Holds control's link.
	 *
	 * @var string
	 */
	public $link = '';
	...
	protected function content_template() {
		...
		<div class="libreria-title-wrapper">
