 ...
 *
 * Class Libreria_Buttonset_Control
 */
class Libreria_Buttonset_Control extends Libreria_Customize_Base_Additional_Control {
	 ...
	 * @var string
	 */
	public $type = 'libreria-buttonset';
	...
	protected function content_template() {
		...
		<div id="input_{{ data.id }}" class="buttonset">
			...
			<div class="buttonset-inner">
				...
				<label for="{{ data.id }}{{ key }}" class="libreria-buttonset">
					{{{ data.choices[ key ] }}}
				</label>
			</div>
			<# } #>
