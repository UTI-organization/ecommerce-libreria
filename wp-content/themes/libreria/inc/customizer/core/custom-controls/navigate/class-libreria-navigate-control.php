 ...
 *
 * Class Libreria_Navigate_Control
 *
 * @package    ThemeGrill
 * @subpackage Libreria
 ...
 * Class Libreria_Navigate_Control
 */
class Libreria_Navigate_Control extends Libreria_Customize_Base_Additional_Control {
	...
	protected function content_template() {
		?>
		<div class="customize-control-content libreria-navigate">
			<?php
			echo sprintf(
