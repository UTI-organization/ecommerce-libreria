 ...
 *
 * Class Libreria_Radio_Image_Control
 *
 * @package    ThemeGrill
 * @subpackage Libreria
 ...
 * Class Libreria_Radio_Image_Control
 */
class Libreria_Radio_Image_Control extends Libreria_Customize_Base_Additional_Control {
	 ...
	 * @var string
	 */
	public $type = 'libreria-radio-image';
	...
	protected function content_template() {
		...
		<div id="input_{{ data.id }}" class="image image-col-{{{ data.image_col }}}">
			...
			<label for="{{ data.id }}{{ key }}" {{{ data.labelStyle }}} class="libreria-radio-image">
