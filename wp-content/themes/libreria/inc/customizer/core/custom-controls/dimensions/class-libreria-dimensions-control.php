...
/**
 * Class Libreria_Dimensions_Control
 */
class Libreria_Dimensions_Control extends Libreria_Customize_Base_Additional_Control {
	 ...
	 * @var string
	 */
	public $type = 'libreria-dimensions';
				...
				<div class="control">
					...
					<div class="top">
						...
						<div class="input-wrapper">
							<input type="text" id="libreria-top-{{{ data.id || data.name }}}
							<# if ( data.value['top'] ) { #>
