<?php
/**
 * Libreria customizer base control class for theme customize options.
 *
 * Class Libreria_Customize_Base_Control
 *
 * @package    ThemeGrill
 * @subpackage Libreria
...
/**
 * Libreria customizer base control class.
 *
 * Class Libreria_Customize_Base_Control
 */
class Libreria_Customize_Base_Control {
...
return new Libreria_Customize_Base_Control();
