 ...
 *
 * Class Libreria_Dropdown_Categories_Control
 *
 * @package    ThemeGrill
 * @subpackage Libreria
 ...
 * Class Libreria_Dropdown_Categories_Control
 */
class Libreria_Dropdown_Categories_Control extends Libreria_Customize_Base_Additional_Control {
	 ...
	 * @var string
	 */
	public $type = 'libreria-dropdown-categories';
