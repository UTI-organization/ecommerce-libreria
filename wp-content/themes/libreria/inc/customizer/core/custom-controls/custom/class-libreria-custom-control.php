 ...
 * Class Libreria_Custom_Control
 */
class Libreria_Custom_Control extends Libreria_Customize_Base_Additional_Control {
	...
	protected function content_template() {
		...
		<# if ( data.info ) { #>
		<div class="libreria-custom-info">
			{{{ data.info }}}
		</div>
		<# } #>

		<# if ( data.links ) { #>
		<ul class="libreria-custom-links">
