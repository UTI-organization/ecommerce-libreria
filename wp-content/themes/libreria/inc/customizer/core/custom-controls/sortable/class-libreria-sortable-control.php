 ...
 *
 * Class Libreria_Sortable_Control
 *
 * @package    ThemeGrill
 * @subpackage Libreria
 ...
 * Class Libreria_Sortable_Control
 */
class Libreria_Sortable_Control extends Libreria_Customize_Base_Additional_Control {
	 ...
	 * @var string
	 */
	public $type       = 'libreria-sortable';

	/**
	 * Holds items that are not meant to be sortable.
	 *
	 * @var array
	 */
	...
	protected function content_template() {
		...
		<ul class="unsortable">
			...
			<li {{{ data.inputAttrs }}} class='libreria-sortable-item' data-value='{{ choiceID }}'>
				<i class="dashicons dashicons-visibility visibility"></i>
				{{{ choiceLabel }}}
			</li>
			<# }else { #>
			<li {{{ data.inputAttrs }}} class='libreria-sortable-item invisible' data-value='{{ choiceID }}'>
				<i class="dashicons dashicons-visibility visibility"></i>
				{{{ choiceLabel }}}
			</li>
			<# } #>
