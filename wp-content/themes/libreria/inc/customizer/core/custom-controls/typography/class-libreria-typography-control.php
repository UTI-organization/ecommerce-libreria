 ...
 *
 * Class Libreria_Typography_Control
 *
 * @package    ThemeGrill
 * @subpackage Libreria
 ...
 * Class Libreria_Typography_Control
 */
class Libreria_Typography_Control extends Libreria_Customize_Base_Additional_Control {
	 ...
	 * @var string
	 */
	public $type = 'libreria-typography';
	...
	public function enqueue() {
		...
		$google_font_subsets = Libreria_Fonts::get_google_font_subsets();
		$localize_scripts    = array(
			'standardfontslabel' => esc_html__( 'Standard Fonts', 'libreria' ),
			'googlefontslabel'   => esc_html__( 'Google Fonts', 'libreria' ),
		...
		if ( ! empty( $custom_fonts ) ) {
			$localize_scripts['customfontslabel'] = esc_html__( 'Custom Fonts', 'libreria' );
		...
		wp_localize_script(
			...
			'LibreriaCustomizerControlTypography',
			$localize_scripts
		);
		...
		wp_localize_script(
			'libreria-customize-controls',
			'LibreriaCustomizerControlTypographySubsets',
			$google_font_subsets
		);
	...
	protected function format_variants_array( $variants ) {
		...
		$font_variants  = Libreria_Fonts::get_font_variants();
	...
	public function get_system_fonts() {
		...
		$standard_fonts       = Libreria_Fonts::get_system_fonts();
	...
	public function get_google_fonts() {
		...
		$google_fonts          = Libreria_Fonts::get_google_fonts();
		$font_variants         = Libreria_Fonts::get_font_variants();
		$foogle_fonts__subsets = Libreria_Fonts::get_google_font_subsets();
	...
	public function get_custom_fonts() {
		...
		$custom_fonts       = Libreria_Fonts::get_custom_fonts();
	...
	public function to_json() {
		...
		$this->json['languages']   = Libreria_Fonts::get_google_font_subsets();
	...
	protected function content_template() {
		...
		<div class="customize-control-content">
			...
			<div class="font-family">
				<span class="customize-control-title"><?php esc_html_e( 'Family', 'libreria' ); ?></span>
				<div class="libreria-field-content">
					<select {{{ data.inputAttrs }}} id="libreria-font-family-{{{ data.id || data.name }}}"></select>
				</div>
			</div>

			<# if ( data.default['font-weight'] ) { #>
			<div class="font-weight">
				<span class="customize-control-title"><?php esc_html_e( 'Weight', 'libreria' ); ?></span>
				<div class="libreria-field-content">
					<select {{{ data.inputAttrs }}} id="libreria-font-weight-{{{ data.id || data.name }}}"></select>
				</div>
			</div>
			<# } #>
			...
			<div class="subsets">
				<span class="customize-control-title"><?php esc_html_e( 'Subset(s)', 'libreria' ); ?></span>
				<div class="libreria-field-content">
					<select {{{ data.inputAttrs }}} id="libreria-subsets-{{{ data.id || data.name }}}" multiple>
			...
			<div class="font-size">
				<span class="customize-control-title"><?php esc_html_e( 'Size', 'libreria' ); ?></span>
				...
				<div class="desktop control-wrap active">
					<input type="text"
						   id="libreria-font-size-desktop-{{{ data.id || data.name }}}"
						   data-device="desktop"
				...
				<div class="tablet control-wrap">
					<input type="text"
						   id="libreria-font-size-tablet-{{{ data.id || data.name }}}"
						   data-device="tablet"
							<# if ( data.value['font-size'] ) { #>
				...
				<div class="mobile control-wrap">
					<input type="text"
						   id="libreria-font-size-mobile-{{{ data.id || data.name }}}"
						   data-device="mobile"
							<# if ( data.value['font-size'] ) { #>
			...
			<div class="line-height">
				<span class="customize-control-title"><?php esc_html_e( 'Line Height', 'libreria' ); ?></span>
				<ul class="responsive-switchers">
					<li class="desktop">
						<button type="button" class="preview-desktop active" data-device="desktop">
							<i class="dashicons dashicons-desktop"></i>
				...
				<div class="desktop control-wrap active">
					<input type="text"
						   id="libreria-line-height-desktop-{{{ data.id || data.name }}}"
						   data-device="desktop"
				...
				<div class="tablet control-wrap">
					<input type="text"
						   id="libreria-line-height-tablet-{{{ data.id || data.name }}}"
						   data-device="tablet"
							<# if ( data.value['line-height'] ) { #>
				...
				<div class="mobile control-wrap">
					<input type="text"
						   id="libreria-line-height-mobile-{{{ data.id || data.name }}}"
						   data-device="mobile"
							<# if ( data.value['line-height'] ) { #>
			...
			<div class="letter-spacing">
				<span class="customize-control-title"><?php esc_html_e( 'Letter Spacing', 'libreria' ); ?></span>
				<ul class="responsive-switchers">
					<li class="desktop">
						<button type="button" class="preview-desktop active" data-device="desktop">
							<i class="dashicons dashicons-desktop"></i>
				...
				<div class="desktop control-wrap active">
					<input type="text"
						   id="libreria-letter-spacing-desktop-{{{ data.id || data.name }}}"
						   data-device="desktop"
				...
				<div class="tablet control-wrap">
					<input type="text"
						   id="libreria-letter-spacing-tablet-{{{ data.id || data.name }}}"
						   data-device="tablet"
							<# if ( data.value['letter-spacing'] ) { #>
				...
				<div class="mobile control-wrap">
					<input type="text"
						   id="libreria-letter-spacing-mobile-{{{ data.id || data.name }}}"
						   data-device="mobile"
							<# if ( data.value['letter-spacing'] ) { #>
			...
			<div class="font-style">
				<span class="customize-control-title"><?php esc_html_e( 'Style', 'libreria' ); ?></span>
				<div class="libreria-field-content">
					<select {{{ data.inputAttrs }}} id="libreria-font-style-{{{ data.id || data.name }}}">
						<option value="normal"
						<# if ( 'normal' === data.value['font-style'] ) { #> selected <# }
						#>><?php esc_html_e( 'Normal', 'libreria' ); ?></option>
						<option value="italic"
						<# if ( 'italic' === data.value['font-style'] ) { #> selected <# }
						#>><?php esc_html_e( 'Italic', 'libreria' ); ?></option>
						<option value="oblique"
						<# if ( 'oblique' === data.value['font-style'] ) { #> selected <# }
						#>><?php esc_html_e( 'Oblique', 'libreria' ); ?></option>
						<option value="initial"
						<# if ( 'initial' === data.value['font-style'] ) { #> selected <# }
						#>><?php esc_html_e( 'Initial', 'libreria' ); ?></option>
						<option value="inherit"
						<# if ( 'inherit' === data.value['font-style'] ) { #> selected <# }
						#>><?php esc_html_e( 'Inherit', 'libreria' ); ?></option>
					</select>
				</div>
			</div>
			<# } #>
			...
			<div class="text-transform">
				<span class="customize-control-title"><?php esc_html_e( 'Transform', 'libreria' ); ?></span>
				<div class="libreria-field-content">
					<select {{{ data.inputAttrs }}} id="libreria-text-transform-{{{ data.id || data.name }}}">
						<option value="none"
						<# if ( 'none' === data.value['text-transform'] ) { #> selected <# }
						#>><?php esc_html_e( 'None', 'libreria' ); ?></option>
						<option value="capitalize"
						<# if ( 'capitalize' === data.value['text-transform'] ) { #> selected <# }
						#>><?php esc_html_e( 'Capitalize', 'libreria' ); ?></option>
						<option value="uppercase"
						<# if ( 'uppercase' === data.value['text-transform'] ) { #> selected <# }
						#>><?php esc_html_e( 'Uppercase', 'libreria' ); ?></option>
						<option value="lowercase"
						<# if ( 'lowercase' === data.value['text-transform'] ) { #> selected <# }
						#>><?php esc_html_e( 'Lowercase', 'libreria' ); ?></option>
						<option value="initial"
			...
			<div class="text-decoration">
				<span class="customize-control-title"><?php esc_html_e( 'Decoration', 'libreria' ); ?></span>
				<div class="libreria-field-content">
					<select {{{ data.inputAttrs }}} id="libreria-text-decoration-{{{ data.id || data.name }}}">
						<option value="none"
						<# if ( 'none' === data.value['text-decoration'] ) { #> selected <# }
						#>><?php esc_html_e( 'None', 'libreria' ); ?></option>
						<option value="underline"
						<# if ( 'underline' === data.value['text-decoration'] ) { #> selected <# }
						#>><?php esc_html_e( 'Underline', 'libreria' ); ?></option>
						<option value="overline"
						<# if ( 'overline' === data.value['text-decoration'] ) { #> selected <# }
						#>><?php esc_html_e( 'Overline', 'libreria' ); ?></option>
						<option value="line-through"
						<# if ( 'line-through' === data.value['text-decoration'] ) { #> selected <# }
						#>><?php esc_html_e( 'Line Through', 'libreria' ); ?></option>
						<option value="initial"
