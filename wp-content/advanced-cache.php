...
// WP-Optimize advanced-cache.php (written by version: 3.2.9) (do not change this line, it is used for correctness checks)
...
$possible_plugin_locations = array(
	...
	'/opt/lampp/htdocs/wordpress/wp-content/plugins/wp-optimize/cache',
);
...
if (false === $plugin_location) {
	...
	if (strcasecmp('http://localhost/wordpress/', $protocol . '://' . $host . $request_uri) === 0) {
...
if (false !== $plugin_location) {
	...
	if (!defined('WPO_CACHE_EXT_DIR')) define('WPO_CACHE_EXT_DIR', '/opt/lampp/htdocs/wordpress/wp-content/plugins/wp-optimize/cache/extensions');
}
